...
if __name__ == '__main__':
    ...
    parser.add_argument("--render_size", help="Size of rendered panorama provided as (height, width)", nargs="*", type=int, default=[320, 640])
    parser.add_argument("--trans_bound", help="Size of translation bound for generating pairs as (size_x, size_y, size_z)", nargs="*", type=float, default=[0.5, 0.5, 0.25])
    parser.add_argument("--rot_bound", help="Size of rotation bound for generating pairs as (size_yaw, size_pitch, size_roll)", nargs="*", type=float, default=[30, 15, 10])
